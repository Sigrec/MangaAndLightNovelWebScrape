...
public partial class AmazonJapan
{
    ...
    public const string WEBSITE_URL = "https://www.amazon.co.jp";
    ...
    internal async Task CreateAmazonJapanTask(string bookTitle, BookType bookType, ConcurrentBag<List<EntryModel>> MasterDataList, WebDriver driver)
    {
        await Task.Run(() => 
        {
