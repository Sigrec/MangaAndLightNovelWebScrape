namespace MangaAndLightNovelWebScrape.Websites
{
    public partial class MangaMart
    {
        ...
        private List<string> MangaMartLinks = [];
        private List<EntryModel> MangaMartData = [];
        ...
        internal async Task CreateMangaMartTask(string bookTitle, BookType bookType, List<List<EntryModel>> MasterDataList, WebDriver driver)
        {
            await Task.Run(() =>
            {
        ...
        private static string GenerateWebsiteUrl(BookType bookType, string bookTitle, uint curPageNum)
        {
            ...
            string url = $"https://mangamart.com/search?type=product&q={Uri.EscapeDataString(bookTitle)}{(bookType == BookType.Manga ? string.Empty : "+novel")}&page={curPageNum}"; ;
