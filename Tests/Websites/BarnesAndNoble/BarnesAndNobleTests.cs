namespace Tests.Websites
{
    public class BarnesAndNobleTests
    {
        ...
        public async Task BarnesAndNoble_AdventuresOfDai_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\BarnesAndNoble\BarnesAndNobleAdventuresOfDaiMangaData.txt")));
        }
        ...
        public async Task BarnesAndNoble_AttackOnTitan_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\BarnesAndNoble\BarnesAndNobleAttackOnTitanMangaData.txt")));
        }
        ...
        public async Task BarnesAndNoble_OnePiece_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\BarnesAndNoble\BarnesAndNobleOnePieceMangaData.txt")));
        }
        ...
        public async Task BarnesAndNoble_Naruto_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\BarnesAndNoble\BarnesAndNobleNarutoMangaData.txt")));
        }
        ...
        public async Task BarnesAndNoble_Naruto_Novel_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\BarnesAndNoble\BarnesAndNobleNarutoNovelData.txt")));
        }
        ...
        public async Task BarnesAndNoble_Bleach_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\BarnesAndNoble\BarnesAndNobleBleachMangaData.txt")));
        }
        ...
        public async Task BarnesAndNoble_COTE_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\BarnesAndNoble\BarnesAndNobleCOTEMangaData.txt")));
        }
        ...
        public async Task BarnesAndNoble_COTE_Novel_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\BarnesAndNoble\BarnesAndNobleCOTENovelData.txt")));
        }
        ...
        public async Task BarnesAndNoble_Overlord_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\BarnesAndNoble\BarnesAndNobleOverlordMangaData.txt")));
        }
        ...
        public async Task BarnesAndNoble_DimensionalSeduction_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\BarnesAndNoble\BarnesAndNobleDimensionalSeductionMangaData.txt")));
        }
        ...
        public async Task BarnesAndNoble_AkaneBanashi_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\BarnesAndNoble\BarnesAndNobleAkaneBanashiMangaData.txt")));
        }
        ...
        public async Task BarnesAndNoble_07Ghost_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\BarnesAndNoble\BarnesAndNoble07GhostMangaData.txt")));
        }
        ...
        public async Task BarnesAndNoble_JujutsuKaisen_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\BarnesAndNoble\BarnesAndNobleJujutsuKaisenMangaData.txt")));
        }
        ...
        public async Task BarnesAndNoble_FMAB_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\BarnesAndNoble\BarnesAndNobleFMABMangaData.txt")));
        }
        ...
        public async Task BarnesAndNoble_Berserk_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\BarnesAndNoble\BarnesAndNobleBerserkMangaData.txt")));
        }
        ...
        public async Task BarnesAndNoble_Toilet_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\BarnesAndNoble\BarnesAndNobleToiletMangaData.txt")));
        }
