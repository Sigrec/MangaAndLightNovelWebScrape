namespace Tests.Websites.Britain
{
    public class ForbiddenPlanetTest
    {
        ...
        public async Task ForbiddenPlanet_Bleach_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\Britain\Data\ForbiddenPlanet\ForbiddenPlanetBleachManga.txt")));
        }
        ...
        public async Task ForbiddenPlanet_AttackOnTitan_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\Britain\Data\ForbiddenPlanet\ForbiddenPlanetAttackOnTitanManga.txt")));
        }
    }
}