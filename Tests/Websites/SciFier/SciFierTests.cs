namespace Tests.Websites
{
    ...
    public class SciFierTests
    {
        ...
        [
            new object[] { "Akane-Banashi", BookType.Manga, Region.Australia, @"C:\MangaAndLightNovelWebScrape\Tests\Websites\SciFier\SciFierAkaneBanashiMangaData.txt", false },
            new object[] { "jujutsu kaisen", BookType.Manga, Region.Europe, @"C:\MangaAndLightNovelWebScrape\Tests\Websites\SciFier\SciFierJujutsuKaisenMangaData.txt", false },
            ...
            new object[] { "Naruto", BookType.LightNovel, Region.America, @"C:\MangaAndLightNovelWebScrape\Tests\Websites\SciFier\SciFierNarutoNovelData.txt", false }, 
            ...
            new object[] { "attack on titan", BookType.Manga, Region.America, @"C:\MangaAndLightNovelWebScrape\Tests\Websites\SciFier\SciFierAttackOnTitanMangaData.txt", false }, 
            ...
            new object[] { "Overlord", BookType.LightNovel, Region.Britain, @"C:\MangaAndLightNovelWebScrape\Tests\Websites\SciFier\SciFierOverlordNovelData.txt", false }, 
            new object[] { "overlord", BookType.Manga, Region.Europe, @"C:\MangaAndLightNovelWebScrape\Tests\Websites\SciFier\SciFierOverlordMangaData.txt", false },
            ...
            new object[] { "Berserk", BookType.Manga, Region.America, @"C:\MangaAndLightNovelWebScrape\Tests\Websites\SciFier\SciFierBerserkMangaData.txt", false },
            new object[] { "Toilet-bound Hanako-kun", BookType.Manga, Region.America, @"C:\MangaAndLightNovelWebScrape\Tests\Websites\SciFier\SciFierToiletMangaData.txt", false },
