namespace Tests.Websites
{
    ...
    public class RobertsAnimeCornerStoreTests
    {
        ...
        public async Task RobertsAnimeCornerStore_COTE_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaAndLightNovelWebScrape\Tests\Websites\RobertsAnimeCornerStore\RobertsAnimeCornerStoreCOTEMangaData.txt")));
        }
