namespace Tests.Websites.America
{
    public class BooksAMillionTests
    {
        ...
        public async Task BooksAMillion_OnePiece_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\BooksAMillion\BooksAMillionOnePieceMangaData.txt")));
        }
        ...
        public async Task BooksAMillion_Naruto_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\BooksAMillion\BooksAMillionNarutoMangaData.txt")));
        }
        ...
        public async Task BooksAMillion_Naruto_Novel_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\BooksAMillion\BooksAMillionNarutoNovelData.txt")));
        }
        ...
        public async Task BooksAMillion_Bleach_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\BooksAMillion\BooksAMillionBleachMangaData.txt")));
        }
        ...
        public async Task BooksAMillion_COTE_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\BooksAMillion\BooksAMillionCOTEMangaData.txt")));
        }
        ...
        public async Task BooksAMillion_COTE_Novel_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\BooksAMillion\BooksAMillionCOTENovelData.txt")));
        }
        ...
        public async Task BooksAMillion_Overlord_Novel_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\BooksAMillion\BooksAMillionOverlordNovelData.txt")));
        }
        ...
        public async Task BooksAMillion_Overlord_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\BooksAMillion\BooksAMillionOverlordMangaData.txt")));
        }
        ...
        public async Task BooksAMillion_DimensionalSeduction_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\BooksAMillion\BooksAMillionDimensionalSeductionMangaData.txt")));
        }
        ...
        public async Task BooksAMillion_AkaneBanashi_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\BooksAMillion\BooksAMillionAkaneBanashiMangaData.txt")));
        }
        ...
        // {
        //     Assert.That(BooksAMillion.GetBooksAMillionData("07-ghost", Book.Manga, false), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\BooksAMillion\BooksAMillion07GhostMangaData.txt")));
        // }
        ...
        public async Task BooksAMillion_JujutsuKaisen_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\BooksAMillion\BooksAMillionJujutsuKaisenMangaData.txt")));
        }
        ...
        public async Task BooksAMillion_FMAB_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\BooksAMillion\BooksAMillionFMABMangaData.txt")));
        }
        ...
        public async Task BooksAMillion_Berserk_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\BooksAMillion\BooksAMillionBerserkMangaData.txt")));
        }

        // [Test, Description("Validates Manga Series w/ Illustration Entries & Vol 0")]
        // public async Task BooksAMillion_Toilet_Manga_Test()
        // {
        //     Assert.That(BooksAMillion.GetBooksAMillionData("Toilet-bound Hanako-kun", Book.Manga, false), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\BooksAMillion\BooksAMillionToiletMangaData.txt")));
        // }
