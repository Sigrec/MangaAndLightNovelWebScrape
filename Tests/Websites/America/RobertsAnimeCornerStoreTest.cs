namespace Tests.Websites
{
    ...
    public class RobertsAnimeCornerStoreTest
    {
        ...
        public async Task RobertsAnimeCornerStore_OnePiece_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\RobertsAnimeCornerStore\RobertsAnimeCornerStoreOnePieceMangaData.txt")));
        }
        ...
        public async Task RobertsAnimeCornerStore_Naruto_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\RobertsAnimeCornerStore\RobertsAnimeCornerStoreNarutoMangaData.txt")));
        }
        ...
        public async Task RobertsAnimeCornerStore_Bleach_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\RobertsAnimeCornerStore\RobertsAnimeCornerStoreBleachMangaData.txt")));
        }
        ...
        public async Task RobertsAnimeCornerStore_COTE_Novel_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\RobertsAnimeCornerStore\RobertsAnimeCornerStoreCOTENovelData.txt")));
        }
        ...
        public async Task RobertsAnimeCornerStore_COTE_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\RobertsAnimeCornerStore\RobertsAnimeCornerStoreCOTEMangaData.txt")));
        }
        ...
        public async Task RobertsAnimeCornerStore_DimensionalSeduction_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\RobertsAnimeCornerStore\RobertsAnimeCornerStoreDimensionalSeductionMangaData.txt")));
        }
        ...
        public async Task RobertsAnimeCornerStore_AkaneBanashi_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\RobertsAnimeCornerStore\RobertsAnimeCornerStoreAkaneBanashiMangaData.txt")));
        }
        ...
        public async Task RobertsAnimeCornerStore_FMAB_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\RobertsAnimeCornerStore\RobertsAnimeCornerStoreFMABMangaData.txt")));
        }
        ...
        public async Task RobertsAnimeCornerStore_Berserk_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\RobertsAnimeCornerStore\RobertsAnimeCornerStoreBerserkMangaData.txt")));
        }
        ...
        public async Task RobertsAnimeCornerStore_GoodbyeEri_Manga_Test()
        {
            ...
            Assert.That(Scrape.GetResults(), Is.EqualTo(ImportDataToList(@"C:\MangaLightNovelWebScrape\Tests\Websites\America\Data\RobertsAnimeCornerStore\RobertsAnimeCornerStoreGoodbyeEriMangaData.txt")));
        }
    }
}